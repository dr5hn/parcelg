...
return [
    ...
    */
    ...
    'options' => [
        'application' => env('APP_NAME', 'ParcelG'),
        'repository' => 'https://dr5hn@github.com/dr5hn/parcelg.git',
        'php_fpm_service' => 'php7.3-fpm',
        'keep_releases' => 1,
        'git_tty' => true,
        'branch' => 'master',
        'bin/composer' => '~/composer.phar',
        'http_user' => 'z2tx6djwonze',
        'writable_mode' => 'chmod',
        'organization' => 'darshan-gada',
        'projects' => [
            'parcel-g'
        ],
        'token' => '63d2da9672c64664bf6206ce5ebbd33618bc8e00454c462d8a57cb7a5d9349b8',
        'version' => '0.0.1',
    ],
    ...
    */
    ...
    'hosts' => [
        'cms.parcelg.com' => [
            'deploy_path' => '/home/z2tx6djwonze/public_html/padmin',
            'user' => 'z2tx6djwonze',
            'stage' => 'prod',
        ],
    ],
